...
void Config::ReadLayoutValues() {
    ...
    ReadGlobalSetting(Settings::values.vertical_screen_gap);
    ReadGlobalSetting(Settings::values.horizontal_screen_gap);
...
void Config::SaveLayoutValues() {
    ...
    WriteGlobalSetting(Settings::values.horizontal_screen_gap);
    WriteGlobalSetting(Settings::values.vertical_screen_gap);
